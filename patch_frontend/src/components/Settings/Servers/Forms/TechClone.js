...
export default function TechClone(props) {
  ...
  const submitFormTechnology = (data) => {
    ...
    // console.log(data);
    Axios.post(URLs().TechnologyConfig + "clone/", data)
      .then((res) => {
      ...
      <Form onSubmit={handleSubmit(submitFormTechnology)}>
          ...
          <div className="col-md-12">
            <div className="form-group mr-2 ml-2">
              ...
              >
                ...
                {tech.map((d, index) => (
                  <option key={index} value={d.technology_id}>
                    {d.technology_name}
                  </option>
                ))}
              </select>
          ...
          <div className="col-md-12">
            <div className="form-group mr-2 ml-2">
              <input
                ...
                placeholder="Technology Clone Name"
                className="form-control"
                ref={register}
                required
              />
        ...
        <div className="float-right mb-2 mr-2">
          <Button className="btn btn-medium btn-theme">
            <i className="fas fa-chevron-down"></i>&nbsp;Create
          </Button>
        </div>
      </Form>
    </>
