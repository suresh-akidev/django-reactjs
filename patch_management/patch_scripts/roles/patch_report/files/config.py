        ...
        def __init__(self,filename):
                ...
                with open(filename,'r') as f:
                        for data in yaml.safe_load_all(f):
                                ...
                                self.smtp_server = data.get('Mail').get('SMTP_Mail_Server')
                                self.fromAddress = data.get('Mail').get('From_Address')
                                self.toAddress = data.get('Mail').get('Recipients').get('Patch_Management_Result_Recipients')
                                self.ccAddress = data.get('Mail').get('Recipients').get('Patch_Management_Report_CC')
